      ...
      >
        ...
        <div className="mt-2 text-sm text-green-700 dark:text-green-300 space-y-1">
          {result.tableCount !== undefined && (
            <p>Found {result.tableCount} tables</p>
          )}
          {result.connectionType && (
            <p>Connection: {result.connectionType}</p>
          )}
 ...
 *
 * @param props - SAPConnectionFormProps
 * @returns JSX.Element
 */
      ...
      <div className="max-w-lg w-full">
        ...
        <div className="mb-8 text-center">
          <p className="text-sm text-slate-500 dark:text-slate-400">
            <span>Step 3</span> <span>of 5</span>
          </p>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white mt-2">
            Connect to SAP
          </h1>
          <p className="mt-2 text-slate-600 dark:text-slate-400">
            Enter your SAP HANA or RFC credentials
          </p>
        </div>
        ...
        >
          <FormField
            ...
            describedById={`${formId}-host-error`}
          />
          ...
          <div className="grid grid-cols-2 gap-4">
            <FormField
              ...
              placeholder="PRD"
              describedById={`${formId}-sid-error`}
            />
            ...
            <FormField
              ...
              placeholder="100"
              describedById={`${formId}-client-error`}
            />
          </div>
